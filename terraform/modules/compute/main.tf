...
resource "aws_ecr_repository" "app" {
  ...
  force_delete         = true # Allow easy teardown for assignment
}
...
# IAM Role for Execution (pulling images, writing logs)
...
resource "aws_ecs_task_definition" "app" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      { name = "PGHOST", value = element(split(":", var.db_endpoint), 0) },
